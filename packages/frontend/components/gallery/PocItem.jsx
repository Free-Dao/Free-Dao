...
const PocItem = ({
  freedao, isVisible = true, demo = false, ...otherProps
}) => {
      ...
      >
        <div>
          ...
          {isLoading ? (
            ...
            <>
              <StyledHeadingThree className="name" style={customStyle}>{freedao.name}</StyledHeadingThree>
              <StyledText isVisible className="description">{freedao.description}</StyledText>
            </>
          )}
          ...
          <>
            <StyledAddressBtn
              onClick={() => copyToClipboard(freedao.address)}
            >
