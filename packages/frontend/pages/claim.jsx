...
const Claim = () => {
  ...
  const claimPoc = async (e) => {
    ...
    try {
      ...
      console.error("Error claiming Freedao: ", err);
      setTimeout(() => {
  ...
  return (
    <Page title="Claim">
      <StyledContainer>
        <StyledHeadingOne>Claim Freedao</StyledHeadingOne>
          ...
          <StyledForm>
            <StyledMargin isVisible={pocData.name}>
              <PocItem
                ...
                style={{
                  width: "110%",
                  marginLeft: `${isSmallerThanSm ? "-5%" : "0"}`,
                }}
              />
            </StyledMargin>

            <StyledFormItem isVisible normalPos>
              <StyledLabel>Set your Address</StyledLabel>
              <StyledInput
                type="text"
                placeholder="Name"
                value={recipient}
            ...
            >
              {claimStep === CLAIM_STEP.minting && "Minting Freedao..."}
              {claimStep === CLAIM_STEP.success &&
                "Freedao successfully claimed"}
              {claimStep === CLAIM_STEP.error &&
                "Error claiming Freedao, please try again later"}
            </StyledText>

            <StyledFormItem
              isVisible={
                claimStep === CLAIM_STEP.setAddress ||
                claimStep === CLAIM_STEP.error ||
                claimStep === CLAIM_STEP.success
              }
              normalPos
